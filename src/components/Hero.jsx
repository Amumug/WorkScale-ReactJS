...
const Hero = () => {
  ...
  return (
    <section className="flex flex-row flex-col ${styles.paddingY} justify-center items-center ">
      ...
      <h4 className="text-center text-gray-700 dark:text-slate-300 text-sm font-medium font-['Inter', sans-serif] mt-4">Creators, designer, engineers, entrepreneurs and and story tellers.</h4>
      <div>
        <div className="flex flex-col md:flex-row md:justify-center items-center space-y-4 md:space-y-0 md:space-x-4 mt-8">
          <div className="w-full md:w-[339px] h-[46px] px-7 py-[5px] dark:bg-gradient-to-b from-gray-600 to-slate-600 cursor-pointer bg-gray-900 rounded-lg justify-center items-center gap-2.5 inline-flex">
            <div className="text-neutral-200 dark:text-gray-200  text-lg font-medium font-['Inter', sans-serit]">Open positions</div>
          </div>
        ...
        <div className="mt-10 grid grid-cols-1 mb-8  md:grid-cols-3 gap-8">
          <div className="flex flex-col justify-start items-start gap-3.5">
            ...
            <p className="text-neutral-700 dark:text-gray-200 text-[22px] font-semibold font-['Inter', sans-serif]">Build for career growth</p>
          ...
          <div className="flex flex-col justify-start items-start gap-3.5">
            ...
            <p className="text-neutral-700 dark:text-gray-200 text-[22px] font-semibold font-['Inter', sans-serif]">Work-life balance</p>
            <p className="text-zinc-500 dark:text-neutral-300 text-[13px] font-medium font-['Inter', sans-serif] leading-normal">
          ...
          <div className="flex flex-col justify-start items-start gap-3.5">
            ...
            <p className="text-neutral-700 dark:text-gray-200 text-[22px] font-semibold font-['Inter', sans-serif]">100% remote-friendly</p>
            <p className="text-zinc-500 dark:text-neutral-300 text-[13px] font-medium font-['Inter', sans-serif] leading-normal">
          ...
          <div className="flex flex-col justify-start items-start gap-3.5">
            ...
            <p className="text-neutral-700 dark:text-gray-200 text-[22px] font-semibold font-['Inter', sans-serif]">Diversity and inclusion</p>
            <p className="text-zinc-500 dark:text-neutral-300 text-[13px] font-medium font-['Inter', sans-serif] leading-normal">
              We help you grow in your career with ongoing mentorship, and help you can build your network.
            </p>
          </div>
          ...
          <div className="flex flex-col justify-start items-start gap-3.5">
            ...
            <p className="text-neutral-700 dark:text-gray-200 text-[22px] font-semibold font-['Inter', sans-serif]">Full health care package</p>
            <p className="text-zinc-500  dark:text-neutral-300 text-[13px] font-medium font-['Inter', sans-serif] leading-normal">
          ...
          <div className="flex flex-col justify-start items-start gap-3.5">
            ...
            <p className="text-neutral-700 dark:text-gray-200 text-[22px] font-semibold font-['Inter', sans-serif]">Perk stipends program</p>
            <p className="text-zinc-500 dark:text-neutral-300 text-[13px] font-medium font-['Inter', sans-serif] leading-normal">
